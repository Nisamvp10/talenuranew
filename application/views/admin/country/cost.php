        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"> <a href="<?=base_url('admin/country/cost_list/').$id?>">cost List </a> </li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Create cost <small></small></h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form id="quickForm" novalidate="novalidate" action="<?=base_url('admin/country/costsubmit')?>"  enctype="multipart/form-data" method="post">
                  <?=messages();?>
                <input type="hidden" name="id" value="<?=$id;?>">
                <div class="card-body">

                   <div class="form-group">
                    <label for="exampleInputEmail1">Types of Expenses</label>
                    <input type="text" id="slugtitle" name="title" class="form-control" value="<?=$title;?>" id="exampleInputEmail1" placeholder="">
                  </div>

                  <div class="form-group">
                    <label for="exampleInputEmail1">Annual Expenses in AUD</label>
                    <input type="text" name="cost" class="form-control" value="<?=$cost;?>" id="" placeholder="">
                  </div>
