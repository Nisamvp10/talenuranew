        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><a href="<?=base_url('admin/country/universities/'.$id.' ');?>"> Add New University </a></li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <input type="hidden" id="universityFinder" value="<?=$id;?>">
                <table id="university_pageDatatable" class="table table-bordered table-striped">
                  <thead>
                    <tr>
                      <th>No</th>
                      <th>university</th>
...
<div class="modal fade" id="edituniversity" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
         <form id="universityForm" novalidate="novalidate" action="<?=base_url('admin/country/universitiesUpdate')?>"  enctype="multipart/form-data" method="post">
               
                <input type="hidden" id="universityId" name="id" value="">
                <input type="hidden" id="universitypath" name="path" value="">
                <div class="card-body">

                   <div class="form-group">
                    <label for="exampleInputEmail1">University</label>
                    <input type="text" id="universitynme" name="title" class="form-control" value="" >
                  </div>
