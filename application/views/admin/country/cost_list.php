  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Cost list Data</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active"><a href="<?=base_url('admin/country/cost/'.$id.' ');?>"> Add New Cost  </a></li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <input type="hidden" id="costFinder" value="<?=$id;?>">
                <table id="cost_pageDatatable" class="table table-bordered table-striped">
                  <thead>
                    <tr>
                      <th>No</th>
                      <th>Type of Exppense</th>
                      <th> Amount</th>
                      <th>Action</th>
                    </tr>
                  </thead>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
         <form id="costForm" novalidate="novalidate" action="<?=base_url('admin/country/costUpdate')?>"  enctype="multipart/form-data" method="post">
               
                <input type="hidden" id="costId" name="id" value="">
                <div class="card-body">
                   <div class="form-group">
                    <label for="exampleInputEmail1">Type Exppense</label>
                    <input type="text" id="type_exppense" name="title" class="form-control" value="" >
                  </div>

                  <div class="form-group">
                    <label for="exampleInputEmail1">Annual Expenses</label>
                    <input type="text" name="cost" class="form-control" value="" id="amtcost" placeholder="">
                  </div>
