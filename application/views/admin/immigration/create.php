...
if(!empty($immigration)){
  ...
  $short_description = $immigration->short_description;
  $description  = $immigration->description;
  $image        = $immigration->path;
  $slug         = $immigration->slug;
}else{
  $id=$event=$title =$short_description =$date=$start_date=$end_date= $description = $image=$author =$event_status=$country=$slug='';
}
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form id="quickForm" novalidate="novalidate" action="<?=base_url('admin/immigration/submit')?>"  enctype="multipart/form-data" method="post">
                  <?=messages();?>
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="country" class="form-control" value="<?=$country;?>" id="exampleInputEmail1" placeholder="Enter Title">
                  </div>
