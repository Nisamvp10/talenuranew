...
if(!empty($blog)){
  ...
  $id=$event=$title =$short_description =$date=$start_date=$end_date= $description = $image=$author =$event_status='';
}
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form id="quickForm" novalidate="novalidate" action="<?=base_url('admin/events/submit')?>"  enctype="multipart/form-data" method="post">
                  <?=messages();?>
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="author" class="form-control" value="<?=$author;?>" id="exampleInputEmail1" placeholder="Enter Title">
                  </div>
