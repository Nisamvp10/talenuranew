...
if(isset($_FILES['upload']) && strlen($_FILES['upload']['name']) > 1) {
    ...
    $sepext = explode('.', strtolower($file_name));
    $type = end($sepext);    /** gets extension **/
    $new_image_name = rand(). '.'. $type;
    ...
    // File upload path
    $f_name = setFName($_SERVER['DOCUMENT_ROOT'] .'/'. $upload_dir, F_NAME, ".$new_image_name", 0);
